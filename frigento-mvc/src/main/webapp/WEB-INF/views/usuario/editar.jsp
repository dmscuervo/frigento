...
<div style="width: 50%; float: left; min-width: 300px">
	<h3>
		<fmt:message key="usuario.editar.title" />
	</h3>
	<br />
	<c:url var="urlEditar" value="/usuario/editar" />
	<form:form action="${urlEditar}" method="post" class="form-horizontal" commandName="usuarioForm" id="idForm">
	<form:hidden path="id" />
        ...
        <div class='col-sm-8'> 
			<div class="form-group">
					...
					<input type="button" class="btn btn-default btn-primary"
						...
						onclick="javascript:loadInBody('usuario?sortFieldName=descripcion&sortOrder=asc')">
			</div>
        </div>
    </div>
	</form:form>
