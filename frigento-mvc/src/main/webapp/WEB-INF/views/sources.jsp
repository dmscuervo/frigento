...
<link href="<c:url value="/resources/css/ecommerce.css" />" rel="stylesheet" />
<link href="<c:url value="/resources/css/frigento.css" />" rel="stylesheet" />

<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/datatables/jquery.dataTables.min.css" />" />
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/datatables/dataTables.bootstrap.min.css" />" />
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/datatables/autoFill.bootstrap.min.css" />" />
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/datatables/colReorder.bootstrap.min.css" />" />
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/datatables/rowReorder.dataTables.min.css" />" />
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/datatables/fixedColumns.bootstrap.min.css" />" />
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/datatables/fixedHeader.bootstrap.min.css" />" />
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/datatables/responsive.bootstrap.min.css" />" />
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/datatables/scroller.bootstrap.min.css" />" />
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/datatables/buttons.dataTables.min.css" />" />
...
<link href="//cdn.rawgit.com/Eonasdan/bootstrap-datetimepicker/e8bddc60e73c1ec2475f827be36e1957af72e2ea/build/css/bootstrap-datetimepicker.min.css" rel="stylesheet">
--%>
...
<script type="text/javascript" src="<c:url value="/resources/js/datatables/dataTables.colReorder.min.js" />" ></script>
<script type="text/javascript" src="<c:url value="/resources/js/datatables/dataTables.rowReorder.min.js" />" ></script>
<script type="text/javascript" src="<c:url value="/resources/js/datatables/dataTables.fixedColumns.min.js" />" ></script>
<script type="text/javascript" src="<c:url value="/resources/js/datatables/dataTables.fixedHeader.min.js" />" ></script>
<script type="text/javascript" src="<c:url value="/resources/js/datatables/dataTables.responsive.min.js" />" ></script>
...
<script type="text/javascript" src="https://cdn.datatables.net/autofill/2.1.1/js/autoFill.bootstrap.min.js"></script>
