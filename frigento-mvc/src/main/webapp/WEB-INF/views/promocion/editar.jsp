...
<div style="width: 100%; float: left; min-width: 300px">
	...
	<br />
	<c:url var="urlEditar" value="/promocion/editar" />
	<form:form action="${urlEditar}" method="post" class="form-horizontal" commandName="promoForm" id="idForm">
	<form:hidden path="id" />
	<div class='row'>
        <div class='col-sm-4'>    
			<div class="form-group" >
				<label class="col-sm-2 control-label" for="idDesc">
					<fmt:message key="promocion.descripcion" />
				</label>
			</div>
        </div>
        <div class='col-sm-4'>
